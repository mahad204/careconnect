...
background: #f3f5f9;">
  ...
  <div class="container-fluid p-0">
    ...
    <div class="row justify-content-md-center">
      <?php if (!isset($_GET['page']) && $_GET['page'] !== 'edit_account') {
        ; ?>
            ...
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-md-6 text-right">
                  <a href="profile.php?page=edit_account" class="btn btn-secondary btn-sm">Edit</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <table class="table table-stripped">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php echo $_SESSION['patient_email_address']; ?>
                    </td>
                  </tr>
                  <tr>
                    <th class="text-right">Password</th>
                    <td>
                      <?php echo $_SESSION['patient_password']; ?>
                    </td>
                  </tr>
                  <tr>
                    <th class="text-right">Address</th>
                    <td>
                      <?php echo $_SESSION['patient_address']; ?>
                    </td>
                  </tr>
                  <tr>
                    <th class="text-right">Contactno</th>
                    <td>
                      <?php echo $_SESSION['patient_contact']; ?>
                    </td>
                  </tr>
                  <tr>
                    <th class="text-right">Marital Status</th>
                    <td>
                      <?php echo $_SESSION['patient_maritial']; ?>
                    </td>
                  </tr>
                  <tr>
                    <th class="text-right">Birth</th>
                    <td>
                      <?php echo $_SESSION['patient_birth']; ?>
                    </td>
                  </tr>
                </tbody>
              </table>
