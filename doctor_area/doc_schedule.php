...
if (isset($_POST['make_sched'])) {
    ...
    $select_query = "SELECT * FROM `doctor_schedule_table` WHERE  doctor_schedule_date = '$sched_date'";
    ...
    if ($number > 0) {
        ...
        $sql = "INSERT INTO `doctor_schedule_table` (doctor_id, doctor_schedule_date, doctor_schedule_start_time, doctor_schedule_end_time, average_consulting_time) VALUES ('$doctorId', '$sched_date', '$sched_start_time', '$sched_end_time', '$averageTime')";
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="doctorn" class="form-control"
                                    value="<?php echo getSpecialtyName($conn, $doctorId); ?>" readonly>
                        ...
                        <div class="card-footer">
                            <div class="doc">
                                <div class="col-md-12">
                                    <button class="btn btn-sm btn-primary col-sm-3 offset-md-3" name="make_sched">
                                        Save</button>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-bordered dataTable no-footer" width="100%"
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                $scheds = mysqli_query($conn, "SELECT * FROM `doctor_schedule_table`  WHERE doctor_id = $doctorId ORDER BY doctor_schedule_id ASC");
                                                ?>
                                                <?php foreach ($scheds as $sched): ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-center"><b>
                                                                <?php echo getSpecialtyName($conn, $sched['doctor_id']) ?>
                                                            </b></td>
                                                        <td class="text-center">
                                                            <?php echo $sched['doctor_schedule_date'] ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php echo $sched['doctor_schedule_start_time'] ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php echo $sched['doctor_schedule_end_time'] ?>
                                                        </td>
                                                        <td class="text-center">
                                                            <?php echo $sched['average_consulting_time'] ?>
                                                        </td>
                                                        <td>
